...
Сценарий: <описание сценария> 
	...
	Тогда открылось окно 'Companii (*)'
	И в поле с именем 'Denumirea' я ввожу текст 'Account Timbal SRL'
	...
	И в таблице "Список" я активизирую поле с именем "Denumirea"
	И в таблице "Список" я выбираю текущую строку
	Тогда открылось окно 'Companii (*) *'
	...
	И в поле с именем 'Denumirea' я ввожу текст 'Casa'
	...
	И я нажимаю на кнопку с именем 'ФормаВыбрать'
	Тогда открылось окно 'Наши расчетные счета (*) *'
	И в поле с именем 'Denumirea' я ввожу текст 'VICTORIABANK MDL'
	И я нажимаю на кнопку с именем 'ФормаЗаписатьИЗакрыть'
