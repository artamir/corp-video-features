...
Сценарий: <описание сценария>
	...
	*Согласно	
	...
	И видеовставка картинки "Postanovlenie208" " Постановлению Правительства РМ № 208 от 30-09-2021 «Об утверждении структуры Классификатора занятий Республики Молдова»"
		|'FadeIn' |'Да'|
		|'FadeOut'|'Да'|
	...
	*и 
	...
	И видеовставка картинки "Pricaz11" "Приказу Министерства труда и соцзащиты № 11 от 12-11-2021«Об утверждении Классификатора занятий в Республике Молдова» (Опубликован : 14-01-2022 в Monitorul Офичиал № 6-16 статья № 23) все экономические агенты обязаны использовать классификатор занятостей CO-RM-006-2021."
		|'FadeIn' |'Да'|
		|'FadeOut'|'Да'|
...
//		Затем клик на картинку "NovaeaVkladka" со смещением "20" "-1"
//		//Затем клик на картинку "ZakritiPervuiuVkladku" со смещением "-17" "0"
//		И я выполняю скрипт SikuliX "ZakritiVkladku"
//		//Затем клик на картинку "AdressnaeaStroka" со смещением "65" "-1"
//		И я выполняю скрипт SikuliX "AdressnaeaStroka"
		И я выполняю скрипт SikuliX "Chrome"

	#[autodoc.mute]	
	И я эмулирую ввод текста "cnas.gov.md"
	
	#[autodoc.ignorestep]
	*
		//Дано я нажимаю ENTER
		И я выполняю скрипт SikuliX "TypeENTER"
...
//		И Пауза 2
	...
	*При необходимости можно распечатать форму MR-5 по текущему сотруднику или по всем.
		И Пауза 1										
