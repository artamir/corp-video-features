...
Сценарий: Запись нового "отчета АктИнвентаризацииБСО"

	Дано Я открываю основную форму отчета "АктИнвентаризацииБСО"
	Если появилось предупреждение тогда                       
		И Я устанавливаю название истории 'Не удалось открыть форму элемента/документа отчета'
		Тогда я вызываю исключение "Не удалось открыть форму отчета АктИнвентаризацииБСО"

	И я запоминаю имя формы в переменную 'ИмяФормы'

	
	И Я устанавливаю название истории 'Запись нового отчета'


Сценарий: Запись нового "отчета ОстаткиИОборотыПоБСО"

	Дано Я открываю основную форму отчета "ОстаткиИОборотыПоБСО"
	Если появилось предупреждение тогда                       
		И Я устанавливаю название истории 'Не удалось открыть форму элемента/документа отчета'
		Тогда я вызываю исключение "Не удалось открыть форму отчета ОстаткиИОборотыПоБСО"
...
Сценарий: Запись нового "отчета РеестрБСО"

	Дано Я открываю основную форму отчета "РеестрБСО"
	Если появилось предупреждение тогда                       
		И Я устанавливаю название истории 'Не удалось открыть форму элемента/документа отчета'
		Тогда я вызываю исключение "Не удалось открыть форму отчета РеестрБСО"
